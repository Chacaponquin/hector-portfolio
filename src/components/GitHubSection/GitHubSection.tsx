...
export default function GitHubSection() {
  ...
  return (
    <SectionContainer>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 md:grid-cols-2 gap-y-2 gap-x-3 w-full">
        {REPOSITORIES.map((r, i) => (
          <div
            key={i}
            className="flex flex-col py-5 px-8 w-full rounded-sm dark:bg-secondDarkColor h-max dark:border-none border-regular border-lightSlate"
          >
